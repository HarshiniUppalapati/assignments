...
public class StorySteps {
	...
	public void book_ticket_for_the_corresponding_details() throws Throwable {
	  ...
	  Thread.sleep(2000);
	  SearchResult.dropPoint(driver).click();
	  Thread.sleep(2000);
...
public void enter_person_details() throws Throwable {
	Thread.sleep(2000);
	SearchResult.name(driver).sendKeys("Harshini");
  SearchResult.selectGender(driver);
  SearchResult.age(driver).sendKeys("21");
  SearchResult.mail(driver).sendKeys("uppalapati@gmail.com");
  SearchResult.mob(driver).sendKeys("9999999999");
